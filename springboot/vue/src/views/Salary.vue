...
<!--          <el-input v-model="form.employee" autocomplete="off"></el-input>-->
<!--        </el-form-item>-->
        <el-form-item label="员工">
        ...
        <el-form-item label="工资日期">
          <el-date-picker v-model="form.salaryDate" type="date" value-format="yyyy-MM-dd" placeholder="选择日期"></el-date-picker>
        </el-form-item>
        ...
        <el-form-item label="扣款">
          <el-input v-model="form.deduction" autocomplete="off"></el-input>
        </el-form-item>
<!--        <el-form-item label="总工资">-->
<!--          <el-input v-model="form.totalSalary" autocomplete="off"></el-input>-->
<!--        </el-form-item>-->
